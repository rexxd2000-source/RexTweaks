...
TWEAKS = validate_module("input_latency", [
    ...
    T("il-006", "Disable Pointer Trails",
      "Turns off mouse pointer trails.",
      actions=[("guidance", "Uncheck 'Display pointer trails' in Mouse settings > Pointer Options. Pointer trails add a visual delay and rendering work.")],
      revert=[("guidance", "Re-enable pointer trails.")],
      why="Pointer trails add a visual delay and rendering work.",
      changes="Shows pointer-trail guidance.",
      risk="safe", impact="very low", recommended="recommended",
      tags=["trails", "pointer", "mouse"]),
    T("il-007", "Disable Enhanced Pointer Options",
      "Guidance to clear pointer effects.",
      actions=[("guidance", "Disable 'Enhance pointer precision', 'Display pointer trails', and 'Hide pointer while typing' in Mouse settings > Pointer Options for consistent input.")],
      revert=[("guidance", "Re-enable the pointer options.")],
      why="Pointer effects add latency and visual noise.",
      changes="Shows pointer-options guidance.",
