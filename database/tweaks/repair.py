...
TWEAKS = validate_module("repair", [
    ...
    T("rep-005", "Reset Windows Update Components",
      "Guidance to reset the update stack.",
      actions=[("guidance", "If updates fail repeatedly, stop wuauserv, rename SoftwareDistribution and catroot2, then restart the services — or use the Windows Update troubleshooter.")],
      revert=[("guidance", "No change to revert.")],
      why="A corrupted update cache blocks new updates and fixes.",
      changes="Shows update-reset guidance.",
      risk="safe", impact="low", recommended="recommended", admin=True,
